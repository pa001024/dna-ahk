...
XButton2:: {
  if 1 {
    ...
    ; kb "c"
    ; s 1000
    ; mc 40, 264, "000000", 100
    ; mc 1377, 768, "C6BDAC", 800
    ; mc 40, 185, "000000", 800
    ; mc 1377, 768, "C6BDAC", 800
    ; kb "{Escape}"
      ...
      if ++wave > 139 {
        ...
        try {
          ...
          if Integer(ocrWave) > wave {
            DNAGui.oGui.wave.Text := wave := Integer(ocrWave)
          }
        }
...
F8:: {
  ; AJ.KQHouTai(hwnd, "DX", "DX", "DX", "", 0)
  ; AJ.MoveR(100, 0)
  ; t := readText(120, 234, 140, 250)
  ; drawBorder(120, 234, 140, 250)
  ; msg t
  msg getCharAngle()
}
